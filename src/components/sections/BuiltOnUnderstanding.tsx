...
import { FloatingGlowCard } from "@/components/ui/FloatingGlowCard";
      ...
      <div className="max-w-[1440px] mx-auto px-5 sm:px-10 lg:px-20 flex flex-col gap-10 lg:gap-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
          ...
          <article className="flex flex-col gap-5">
            <div className="relative w-full h-[280px] sm:h-[331px] rounded-[20px] border border-[#D9D9D9]">
              ...
              <FloatingGlowCard
                className="absolute right-3 sm:right-[24px] bottom-4 sm:bottom-[24px] w-[85%] max-w-[290px] z-20"
                items={[
                  {
                    icon: <i className="fi fi-rr-time-twenty-four text-sm sm:text-base" />,
                    text: "Built for uptime, so your operations never stall",
                  },
                  {
                    icon: (
                    ...
                    text: "Infrastructure that scales with you, without slowing down",
                  },
                ]}
              />
            </div>
          ...
          <article className="flex flex-col gap-5">
            <div className="relative w-full h-[280px] sm:h-[331px] rounded-[20px] border border-[#D9D9D9]">
              ...
              <FloatingGlowCard
                className="absolute right-3 sm:right-[24px] bottom-4 sm:bottom-[24px] w-[85%] max-w-[338px] z-20"
                items={[
                  {
                    icon: <i className="fi fi-rr-stats text-sm sm:text-base" />,
                    text: "Actionable insight from the field, without sending teams into hard-to-reach areas",
                  },
                ]}
              />
            </div>
          ...
          {/* Pillar 3: Custom Software & Blockchain Application */}
          <article className="lg:col-span-2 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center pt-4">
            <div className="lg:col-span-6 relative w-full h-[280px] sm:h-[387px] lg:h-[387px] rounded-[20px] border border-[#D9D9D9]">
              <div className="absolute inset-0 rounded-[20px] overflow-hidden">
                <img
              ...
              <FloatingGlowCard
                className="absolute right-3 sm:right-[24px] bottom-4 sm:bottom-[24px] w-[85%] max-w-[270px] z-20"
                items={[
                  {
                    icon: (
                    ...
                    text: "Tailored to your organization needs",
                  },
                  {
                    icon: (
            ...
            <div className="lg:col-span-6 flex flex-col gap-8 lg:gap-[60px]">
              <div className="flex flex-col gap-2">
                <h3 className="text-2xl sm:text-3xl font-semibold text-black font-inter-tight">
                  Custom Software
                </h3>
